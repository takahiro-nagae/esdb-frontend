                    ...
                    <Paper style={{ marginTop: '15px' }}>
                        <Box sx={{ p: 2 }}>
                            ...
                            <Box sx={{ p: 2 }}>
                                ...
                                <Box sx={{ ml: 2 }}>
                                    ...
                                    <NavLink to='https://twitter.com/mabiesdb'>
                                        ...
                                        <span css={iconTextStyle}>公式Twitter</span>
                                    </NavLink>
                                </Box>
                            </Box>
                            <Box sx={{ p: 2 }}>
                            ...
                            <Box sx={{ p: 2 }}>
                                ...
                                <Box sx={{ ml: 2 }}>
                                    <p>
                                        <a href='http://fruitmilk.xii.jp/enchant/'>エンチャント検索っぽいそれ</a>様より大元のデータを頂きました。
                                        <br />
                                    ...
                                    <p>
                                        追加のデータとして一部<a href='https://wikiwiki.jp/mabinogi/'>Mabinogi Wiki</a>
