...
describe('SearchListBody', () => {
    ...
    const { EnchantNameAsc, EnchantNameDesc, NotValEnchantNameAsc, SameSortValue, DispRowPerPage1, DispRowPerPage2 } = composeStories(stories);

    const rowCheck = (row: HTMLElement, data: EnchantData, isDispVal: boolean) => {
        // エンチャント名
