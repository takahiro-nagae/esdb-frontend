...
export const SearchListBody = (props: {
    ...
    return (
        <TableBody>
            {stableSort(props.rowData, getComparator(orderContext.order, orderContext.orderBy))
                ...
                .map((enchant, index) => (
                    <>
                        ...
                        />
                        <LastInfeedAd index={index} dataLength={props.rowData.length} disp_val={enchant.disp_val} />
                    </>
                ))}
        </TableBody>
    );
