...
export const Default: StoryObj<typeof SearchListHead> = {
    decorators: [
        (Story) => {
            return (
                <OrderContext.Provider value={{ orderBy: 'enchant_id', setOrderBy: () => {}, order: 'asc', setOrder: () => {} }}>
                    <table>
                        <Story />
                    </table>
...
export const EnchantNameAsc: StoryObj<typeof SearchListHead> = {
    decorators: [
        (Story) => {
            return (
                <OrderContext.Provider value={{ orderBy: 'enchant_name', setOrderBy: () => {}, order: 'asc', setOrder: () => {} }}>
                    <table>
                        <Story />
                    </table>
                </OrderContext.Provider>
...
export const EnchantNameDesc: StoryObj<typeof SearchListHead> = {
    decorators: [
        (Story) => {
            return (
                <OrderContext.Provider value={{ orderBy: 'enchant_name', setOrderBy: () => {}, order: 'desc', setOrder: () => {} }}>
                    <table>
                        <Story />
                    </table>
                </OrderContext.Provider>
...
export const DescVal: StoryObj<typeof SearchListHead> = {
    decorators: [
        (Story) => {
            return (
                <OrderContext.Provider value={{ orderBy: 'disp_val', setOrderBy: () => {}, order: 'asc', setOrder: () => {} }}>
                    <table>
                        <Story />
                    </table>
                </OrderContext.Provider>
