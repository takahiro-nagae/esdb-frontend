...
describe('getComparator', () => {
    ...
    const mockComparator = (comparator: (a: EnchantData, b: EnchantData) => number) => {
...
describe('stableSort', () => {
    test('昇順', () => {
        const result = stableSort([ Dummy1, Dummy2 ], getComparator('asc', 'enchant_name'));
    ...
    test('降順', () => {
        const result = stableSort([ Dummy1, Dummy2 ], getComparator('desc', 'enchant_name'));
