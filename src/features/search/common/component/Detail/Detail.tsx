...
export const Detail = (props: { enchant: EnchantData }) => {
    const effectKbnArray = props.enchant.effect_kbn ? props.enchant.effect_kbn.split('@') : [];
    const effectNameArray = props.enchant.effect_name ? props.enchant.effect_name.split('@') : [];
    const routeNameArray = props.enchant.route_name ? props.enchant.route_name.split('@') : [];
